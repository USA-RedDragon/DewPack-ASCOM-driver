...
; Generated by Jacob McSwain on 7/29/2021 (UTC)
;
[Setup]
AppID={{d1ceb4a9-0cf4-4920-96b0-31905a49dbad}
AppName=ASCOM DewPack Switch Driver
AppVerName=ASCOM DewPack Switch Driver 6.5.1.0
AppVersion=6.5.1.0
AppPublisher=Jacob McSwain <ascom@mcswain.dev>
AppPublisherURL=mailto:ascom@mcswain.dev
...
OutputDir="."
OutputBaseFilename="DewPack Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\DewPack"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\DewPack"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Jacob\Documents\Projects\C#\DewPack\DewPack\bin\Release\*"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Jacob\Documents\Projects\C#\DewPack\DewPack\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DewPack.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DewPack.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DewPack.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DewPack.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DewPack.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
