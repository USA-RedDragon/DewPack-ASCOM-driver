...
//
// ASCOM Switch driver for DewPack
//
...
{
    //
    // Your driver's DeviceID is ASCOM.DewPack.Switch
    //
    // The Guid attribute sets the CLSID for ASCOM.DewPack.Switch
    // The ClassInterface/None attribute prevents an empty interface called
    // _DewPack from being created and used as the [default] interface
    //
    ...
    /// ASCOM Switch Driver for DewPack.
    /// </summary>
    [Guid("fa7acd04-4fe2-41ec-b18c-62aa3d36a48b")]
    ...
    public class Switch : ISwitchV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.DewPack.Switch";

        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "DewPack Switch Driver";

        internal static string comPortProfileName = "COM Port"; // Constants used for Profile persistence
        internal static string comPortDefault = "COM1";
        internal static string traceStateProfileName = "Trace Level";
        internal static string traceStateDefault = "false";
        internal static string usb0NameProfileName = "USB0 Name";
        internal static string usb0NameDefault = "USB0";
        internal static string usb1NameProfileName = "USB1 Name";
        internal static string usb1NameDefault = "USB1";
        ...
        private PacketSerial serial;

        private string usb0Name, usb1Name;

        /// <summary>
        /// Initializes a new instance of the <see cref="DewPack"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Switch()
        {
            tl = new TraceLogger("", "DewPack");
        ...
        public ArrayList SupportedActions
        {
            get
            {
                tl.LogMessage("SupportedActions Get", "Returning actions");
        ...
        public string Action(string actionName, string actionParameters)
        {
            ...
            {
                var newState = serial.CurrentState.Clone();
                newState.Configuration.Usb0Restore = newState.Usb0;
                newState.Configuration.Usb1Restore = newState.Usb1;
                serial.WriteDeviceState(newState);
                return "";
            }
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "DIY USB Dew Heater Controller. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        public string GetSwitchDescription(short id)
        {
            ...
            tl.LogMessage("GetSwitchDescription", string.Format("GetSwitchDescription({0})", id));
            if (id == 0)
            {
                return "Top USB Port";
            } else if (id == 1)
            {
                return "Bottom USB Port";
            } else
            {
        ...
        public bool GetSwitch(short id)
        {
            ...
            string msg = "Use GetSwitchValue()";
            tl.LogMessage("GetSwitch", string.Format("GetSwitch({0}) - {1}", id, msg));
            throw new MethodNotImplementedException(msg);
        }
        ...
        public void SetSwitch(short id, bool state)
        {
            ...
            string msg = "Use SetSwitchValue()";
            tl.LogMessage("SetSwitch", string.Format("SetSwitch({0}) - {1}", id, msg));
            throw new MethodNotImplementedException(msg);
        }
        ...
        public double GetSwitchValue(short id)
        {
            ...
            tl.LogMessage("GetSwitchValue", string.Format("GetSwitchValue({0})", id));
            switch (id)
            {
                case 0:
                    if (serial.CurrentState.Usb0.Power)
                    {
                        return serial.CurrentState.Usb0.DutyCycle;
                    }
                    else
                        return 0;
                case 1:
                    if (serial.CurrentState.Usb1.Power)
                    {
                        return serial.CurrentState.Usb1.DutyCycle;
                    }
                    else
                        return 0;
            }
        ...
        public void SetSwitchValue(short id, double value)
        {
            ...
            if (id == 0)
            {
                DeviceState newState = serial.CurrentState.Clone();
                newState.Usb0.Power = newState.Usb0.DutyCycle > 0 ? true : false;
                newState.Usb0.DutyCycle = (uint)value;
                serial.WriteDeviceState(newState);
            } else if (id == 1)
            {
                DeviceState newState = serial.CurrentState.Clone();
                newState.Usb1.Power = newState.Usb1.DutyCycle > 0 ? true : false;
                newState.Usb1.DutyCycle = (uint)value;
                serial.WriteDeviceState(newState);
            }
        }
        ...
        private bool IsConnected
        {
            get
            {
                return serial != null ? serial.Connected:false;
            }
        }
        ...
        internal void ReadProfile()
        {
            using (Profile driverProfile = new Profile())
            {
                ...
                usb0Name = driverProfile.GetValue(driverID, usb0NameProfileName, string.Empty, usb0NameDefault);
                usb1Name = driverProfile.GetValue(driverID, usb1NameProfileName, string.Empty, usb1NameDefault);
            }
        }
        ...
        internal void WriteProfile()
        {
            using (Profile driverProfile = new Profile())
            {
                ...
                driverProfile.WriteValue(driverID, usb0NameProfileName, usb0Name.ToString());
                driverProfile.WriteValue(driverID, usb1NameProfileName, usb1Name.ToString());
            }
        }
